...
class shawar_add_to_Cart extends StatelessWidget {
  const shawar_add_to_Cart({
    super.key,
    required this.dark,
    required this.shawar,
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
        onTap: () {
          final cartItem = cartController.convertToCartItem(shawar, 1);
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      ...
                      cartController.removeFromCart(
                          cartController.convertToCartItem(shawar, 1)
                      );
