...
class promo_add_to_cart extends StatelessWidget {
  const promo_add_to_cart({
    super.key,
    required this.dark,
    required this.promo,
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
        onTap: () {
          final cartItem = cartController.convertToCartItem(promo, 1);
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      ...
                      cartController.removeFromCart(
                          cartController.convertToCartItem(promo, 1)
                      );
