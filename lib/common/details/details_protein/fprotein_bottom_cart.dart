...
class fProteinBottomAddToCart extends StatelessWidget {
  const fProteinBottomAddToCart({super.key, required this.protein});
      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            InkWell(onTap: () {
              final cartItem = cartController.convertToCartItem(protein, 1);
                                ...
                                child: IconButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    cartController.removeFromCart(
                                        cartController.convertToCartItem(protein, 1)
                                    );
                                  },
                                ),
                              ),
