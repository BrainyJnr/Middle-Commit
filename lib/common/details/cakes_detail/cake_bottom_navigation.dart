...
class CakeBottomAddToCart extends StatelessWidget {
  const CakeBottomAddToCart({super.key, required this.cake});
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          InkWell(onTap: () {
            final cartItem = cartController.convertToCartItem(cake, 1);
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  cartController.removeFromCart(
                                      cartController.convertToCartItem(cake, 1)
                                  );
                                },
                              ),
                            ),
