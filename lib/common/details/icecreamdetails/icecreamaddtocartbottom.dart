...
class IceBottomAddToCart extends StatelessWidget {
  const IceBottomAddToCart({super.key, required this.ice});
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          InkWell(onTap: () {
            final cartItem = cartController.convertToCartItem(ice, 1);
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  cartController.removeFromCart(
                                      cartController.convertToCartItem(ice, 1)
                                  );
                                },
                              ),
                            ),
