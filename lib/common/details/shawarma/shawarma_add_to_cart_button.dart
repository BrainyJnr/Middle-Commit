...
class ShawarmaBottomAddToCart extends StatelessWidget {
  const ShawarmaBottomAddToCart({super.key, required this.warma});
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          InkWell(onTap: () {
            final cartItem = cartController.convertToCartItem(warma, 1);
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  cartController.removeFromCart(
                                      cartController.convertToCartItem(warma, 1)
                                  );
                                },
                              ),
                            ),
