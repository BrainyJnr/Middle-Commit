...
class DrinkbottomAddToCart extends StatelessWidget {
  const DrinkbottomAddToCart({super.key, required this.drink});
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          InkWell(onTap: () {
            final cartItem = cartController.convertToCartItem(drink, 1);
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  cartController.removeFromCart(
                                      cartController.convertToCartItem(drink, 1)
                                  );
                                },
                              ),
                            ),
