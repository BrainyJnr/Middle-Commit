...
class fDummyData {
  static final List<CategoryModel> category = [
    CategoryModel(id: "01", name: "FOODS", image: fImages.FoodIcon),
    CategoryModel(id: "02", name: "PROTEIN", image: fImages.ProteinIcon),
    CategoryModel(id: "03", name: "PASTRY", image: fImages.Pastry_Icon),
    CategoryModel(id: "04", name: "CAKES", image: fImages.CakeIcon),
    CategoryModel(id: "05", name: "BREAD", image: fImages.BreaadIcon),
    CategoryModel(id: "06", name: "ICE CREAM", image: fImages.Ice_Cream_Icon),
    CategoryModel(id: "07", name: "SHAWARMA", image: fImages.Shawarma),
    CategoryModel(id: "08", name: "PROMO", image: fImages.Promo_Icon),
    CategoryModel(id: "09", name: "DRINKS", image: fImages.DrinkIcon)
  ];
...
//     ),
  ...
  static final List<BannerModel> banners = [
    ...
    BannerModel(id: "003", image: fImages.Banner3, isFeatured: false, name: '')
  ];
}
